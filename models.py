...
data = pd.read_csv("./Datasets/BALANCED-TRAINING-DATASET-W9.csv")
...
dump(model1, "balance_nb_model.joblib")
print("NB - Saved!")
print()
...
dump(model2, "balance_rf_model.joblib")
print("RF - Saved!")
print()
...
dump(model3, "balance_svm_model.joblib")
print("SVM - Saved!")
print()
