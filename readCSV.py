...
data1 = pd.read_csv("./benchmark2.csv")
print(data1)
...
data2 = pd.read_csv("./benchmark3.csv")
print(data2)
...
mycsv.to_csv('benchmark-dataset.csv', index = False, header = headerName)

mycsv = pd.read_csv("benchmark-dataset.csv")
labels = mycsv['Labels']
